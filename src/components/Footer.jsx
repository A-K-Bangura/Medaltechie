      ...
      <div className="container mx-auto px-4 py-12 sm:py-16 w-full max-w-full">
          ...
          <div className="w-full">
            ...
            <ul className="space-y-2">
              {['Home', 'About', 'Portfolio', 'Our Blog', 'Contact'].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase().replace(' ', '-')}`} className="text-neutral-300 hover:text-white transition-colors text-sm sm:text-base">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-neutral-700 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-neutral-300 text-sm sm:text-base">No 43 Soldier Street, Freetown Sierra Leone</span>
            </div>
            <div className="flex items-center space-x-3">
              <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-accent-400 flex-shrink-0" />
              <a href="mailto:medaltechie@gmail.com" className="text-neutral-300 hover:text-white transition-colors text-sm sm:text-base">
                medaltechie@gmail.com
              </a>
            </div>
            <div className="flex items-center space-x-3">
              <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-accent-400 flex-shrink-0" />
              <a href="tel:+23278672866" className="text-neutral-300 hover:text-white transition-colors text-sm sm:text-base">
                +232 78 672866
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-neutral-700 mt-6 sm:mt-8 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 sm:space-x-6 mt-4 sm:mt-0">
            <a href="#" className="text-neutral-400 hover:text-white text-xs sm:text-sm transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-neutral-400 hover:text-white text-xs sm:text-sm transition-colors">
              Terms & Conditions
