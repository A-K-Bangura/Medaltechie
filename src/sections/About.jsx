...
const About = () => {
  ...
  return (
    <section id="about" className="py-16 relative sm:py-20 bg-white w-full max-w-full overflow-hidden">
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex items-start space-x-3">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-semibold text-neutral-100 mb-1 text-sm sm:text-base">{feature.title}</h3>
                    <p className="text-xs sm:text-sm text-neutral-300">{feature.description}</p>
                  </div>
                </div>
              ))}
            </div>
